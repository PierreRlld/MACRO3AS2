...
% (3) [Imports from US in $ = US exports to GER] : "Quarterly – Germany – Goods, Value of Imports, Cost, Insurance, Freight (CIF), US Dollars – United States, Millions" ['IMF/DOT/Q.DE.TMG_CIF_USD.US']
% (4) [Nominal exchange rate 1€=x$] : "Quarterly – US dollar – Euro – Spot – Average" [ECB/EXR/Q.USD.EUR.SP00.A]
%       > We have e = 1/NER
% (5) [CPI Quarterly Index] : "Germany – Inflation (CPI) – Total – 2015=100 – Quarterly [OECD/DP_LIVE/DEU.CPI.TOT.IDX2015.Q]"
